...
# 이벤트가 뜬다(2026-07-30, 실제 답 시도와 구분하기 위해 도입). "넘어가"/"스킵"/"공개해"는
# 짜증유발(annoying) 모드의 명시적 포기·스킵 요청(예: "다음 문제로 넘어가줘", "그냥
# 공개해줘")을 잡기 위해 2026-07-31에 추가 — 계속 거절만 하다가 참가자가 이 표현으로
# 항복해야만 정답을 공개하고 다음으로 넘어간다.
_DONT_KNOW_MARKERS = (
